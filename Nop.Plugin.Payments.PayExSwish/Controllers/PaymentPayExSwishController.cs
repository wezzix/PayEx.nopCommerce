...
namespace Nop.Plugin.Payments.PayExSwish.Controllers
{
    public class PaymentPayExSwishController : Nop.Plugin.Payments.PayEx.Controllers.PaymentPayExController
    {
        ...
        {
            return View("~/Plugins/Payments.PayExSwish/Views/PaymentPayExSwish/PaymentInfo.cshtml");
        }
